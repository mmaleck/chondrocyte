...
- Check out the [existing issues](https://github.com/mmaleck/chondrocyte/issues) and see if there already exist similar issues.
...
- Once you submit your PR, we will review it. We may have questions, so remember to check back on your PR to keep up with the conversation.
